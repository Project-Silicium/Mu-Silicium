...
cat ./BootShim/BootShim.bin "./Build/laurel_sproutPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/LAUREL_SPROUT_UEFI.fd" > "./Build/laurel_sproutPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/LAUREL_SPROUT_UEFI.fd-bootshim"||exit 1
