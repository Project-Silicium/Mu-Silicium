...
cat ./BootShim/BootShim.bin "./Build/j706fPkg/${_TARGET_BUILD_MODE}_CLANGDWARF/FV/J706F_UEFI.fd" > "./Build/j706fPkg/${_TARGET_BUILD_MODE}_CLANGDWARF/FV/J706F_UEFI.fd-bootshim"||exit 1
