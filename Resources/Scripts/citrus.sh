...
cat ./BootShim/BootShim.bin "./Build/citrusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CITRUS_UEFI.fd" > "./Build/citrusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CITRUS_UEFI.fd-bootshim"||exit 1
