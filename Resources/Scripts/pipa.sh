...
cat ./BootShim/BootShim.bin "./Build/pipaPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/PIPA_UEFI.fd" > "./Build/pipaPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/PIPA_UEFI.fd-bootshim"||exit 1
