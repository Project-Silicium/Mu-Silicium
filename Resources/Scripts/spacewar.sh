...
cat ./BootShim/BootShim.bin "./Build/spacewarPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SPACEWAR_UEFI.fd" > "./Build/spacewarPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SPACEWAR_UEFI.fd-bootshim"||exit 1
