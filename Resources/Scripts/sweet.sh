...
cat ./BootShim/BootShim.bin "./Build/sweetPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SWEET_UEFI.fd" > "./Build/sweetPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SWEET_UEFI.fd-bootshim"||exit 1
