...
cat ./BootShim/BootShim.bin "./Build/equuleusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/EQUULEUS_UEFI.fd" > "./Build/equuleusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/EQUULEUS_UEFI.fd-bootshim"||exit 1
