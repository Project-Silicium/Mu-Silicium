...
cat ./BootShim/AARCH64/BootShim.bin "./Build/c1sPkg/${_TARGET_BUILD_MODE}_CLANGDWARF/FV/C1S_UEFI.fd" > "./Resources/bootpayload.bin"||exit 1

python3 ./Resources/Scripts/mkbootimg.py \
  --kernel ./Resources/bootpayload.bin \
  --ramdisk ./Resources/ramdisk \
  --dtb "./Resources/DTBs/c1s.dt" \
