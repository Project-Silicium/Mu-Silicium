...
cat ./BootShim/BootShim.bin "./Build/cebuPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CEBU_UEFI.fd" > "./Build/cebuPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CEBU_UEFI.fd-bootshim"||exit 1
