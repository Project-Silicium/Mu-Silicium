...
cat ./BootShim/BootShim.bin "./Build/ingresPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/INGRES_UEFI.fd" > "./Build/ingresPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/ingres_UEFI.fd-bootshim"||exit 1
