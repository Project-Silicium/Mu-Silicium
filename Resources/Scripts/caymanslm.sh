...
cat ./BootShim/BootShim.bin "./Build/caymanslmPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CAYMANSLM_UEFI.fd" > "./Build/caymanslmPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CAYMANSLM_UEFI.fd-bootshim"||exit 1
