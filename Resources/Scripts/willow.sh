...
cat ./BootShim/BootShim.bin "./Build/willowPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/WILLOW_UEFI.fd" > "./Build/willowPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/WILLOW_UEFI.fd-bootshim"||exit 1
