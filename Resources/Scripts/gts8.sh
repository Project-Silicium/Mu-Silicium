...
cat ./BootShim/BootShim.bin "./Build/gts8Pkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/GTS8_UEFI.fd" > "./Build/gts8Pkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/GTS8_UEFI.fd-bootshim"||exit 1
