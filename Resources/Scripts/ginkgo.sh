...
cat ./BootShim/BootShim.bin "./Build/ginkgoPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/GINKGO_UEFI.fd" > "./Build/ginkgoPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/GINKGO_UEFI.fd-bootshim"||exit 1
