...
cat ./BootShim/BootShim.bin "./Build/capripPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CAPRIP_UEFI.fd" > "./Build/capripPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/CAPRIP_UEFI.fd-bootshim"||exit 1
