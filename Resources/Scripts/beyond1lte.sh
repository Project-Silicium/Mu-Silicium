...
cat ./BootShim/BootShim.bin "./Build/beyond1ltePkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/BEYOND1LTE_UEFI.fd" > "./Build/beyond1ltePkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/BEYOND1LTE_UEFI.fd-bootshim"||exit 1
