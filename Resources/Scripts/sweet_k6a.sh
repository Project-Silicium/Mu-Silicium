...
cat ./BootShim/AARCH64/BootShim.bin "./Build/sweet_k6aPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SWEET_K6A_UEFI.fd" > "./Build/sweet_k6aPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/SWEET_K6A_UEFI.fd-bootshim"||exit 1
