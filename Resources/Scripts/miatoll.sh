...
cat ./BootShim/BootShim.bin "./Build/miatollPkg/${_TARGET_BUILD_MODE}_CLANGDWARF/FV/MIATOLL_UEFI.fd" > "./Build/miatollPkg/${_TARGET_BUILD_MODE}_CLANGDWARF/FV/MIATOLL_UEFI.fd-bootshim"||exit 1
