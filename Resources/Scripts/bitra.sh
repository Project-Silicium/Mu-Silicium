...
cat ./BootShim/BootShim.bin "./Build/bitraPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/BITRA_UEFI.fd" > "./Build/bitraPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/BITRA_UEFI.fd-bootshim"||exit 1
