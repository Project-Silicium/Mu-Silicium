...
cat ./BootShim/BootShim.bin "./Build/venusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/VENUS_UEFI.fd" > "./Build/venusPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/VENUS_UEFI.fd-bootshim"||exit 1
