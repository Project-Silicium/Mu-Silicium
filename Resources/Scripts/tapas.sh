...
cat ./BootShim/AARCH64/BootShim.bin "./Build/tapasPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/TAPAS_UEFI.fd" > "./Build/tapasPkg/${TARGET_BUILD_MODE}_CLANGPDB/FV/TAPAS_UEFI.fd-bootshim"||exit 1
