##
# Script to Build Nintendo Switch UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("HAC-001Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('HAC-001', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "HAC-001", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "HAC-001Pkg/HAC-001.dsc", "Platform Hardcoded")
