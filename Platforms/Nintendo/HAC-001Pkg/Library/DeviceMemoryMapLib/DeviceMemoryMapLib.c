...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"RAM Partition",      0x83E81000, 0x2C17F000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
#ifdef EFI_DEBUG
  {"PStore",             0xB0000000, 0x00200000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH},
#else
  {"RAM Partition",      0xB0000000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
#endif
  {"RAM Partition",      0xB0200000, 0x45800000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
  {"Display Reserved",   0xF5A00000, 0x00384000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH},
  {"RAM Partition",      0xF5D84000, 0x8A27C000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
