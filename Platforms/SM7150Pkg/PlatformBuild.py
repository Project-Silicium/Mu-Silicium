# @file
# Script to Build SM7150 Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SM7150Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('SM7150', 'mu-build', 'cibuild')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SM7150", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SM7150Pkg/SM7150.dsc", "Platform Hardcoded")
