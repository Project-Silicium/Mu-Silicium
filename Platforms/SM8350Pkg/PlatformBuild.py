# @file
# Script to Build SM8350 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SM8350Pkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('SM8350', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "SM8350Pkg/SM8350.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SM8350", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SM8350Pkg/SM8350.dsc", "Platform Hardcoded")
