...
class CommonPlatform ():
    PackagesSupported = ("betalmPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('betalm', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "betalm", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "betalmPkg/betalm.dsc", "Platform Hardcoded")
