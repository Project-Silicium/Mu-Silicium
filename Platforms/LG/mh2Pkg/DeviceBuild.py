...
class CommonPlatform ():
    PackagesSupported = ("mh2Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('mh2', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "mh2", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "mh2Pkg/mh2.dsc", "Platform Hardcoded")
