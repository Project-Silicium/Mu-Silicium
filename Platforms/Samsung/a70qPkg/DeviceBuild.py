...
class CommonPlatform ():
    PackagesSupported = ("a70qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a70q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "a70q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "a70qPkg/a70q.dsc", "Platform Hardcoded")
