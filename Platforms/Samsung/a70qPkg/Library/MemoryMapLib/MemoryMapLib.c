...
gMemoryDescriptor[] = {
    ...
    {"XBL AOP MEM",       0x9AD00000, 0x00240000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_BACK_XN},
    ...
    {"DXE Heap",          0xA0000000, 0x06400000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
