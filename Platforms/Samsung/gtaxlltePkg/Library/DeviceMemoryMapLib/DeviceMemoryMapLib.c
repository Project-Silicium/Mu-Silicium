...
gDeviceMemoryDescriptorEx[] = {
  ...
  //{"FDT Pointer",        0x40050000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
  ...
  //{"DDR Info",           0x0206B000, 0x0002B000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   NS_DEVICE},
