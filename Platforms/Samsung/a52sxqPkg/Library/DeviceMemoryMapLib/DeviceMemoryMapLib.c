...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"MPSS_EFS",           0xA0800000, 0x00300000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN}, // Is this OK? MPSS Located in Kernel Region, which is protected by tz.
//{"HLOS6",              0xA0B00000, 0x1AB00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  ...
  // Memory Hole: 0xB9300000 -> 0xC0000000 (0x06D00000)
  ...
  {"DBI Dump",           0xC5F00000, 0x00F00000, NoHob,  MMAP_IO, INITIALIZED, Conv,   UNCACHED_UNBUFFERED_XN},
  {"ADSP RPC",           0xC6E00000, 0x00800000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"HLOS7",              0xC7600000, 0x08A00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
