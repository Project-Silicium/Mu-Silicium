...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/j6ltePkg
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = RELEASE|DEBUG
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = j6ltePkg/j6lte.fdf
...
[PcdsFixedAtBuild]
  ...
  gSiliciumPkgTokenSpaceGuid.PcdMipiFrameBufferHeight|1480
...
[PcdsDynamicDefault]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdVideoVerticalResolution|1480
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupVideoHorizontalResolution|720
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupVideoVerticalResolution|1480
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupConOutColumn|90
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupConOutRow|77
  gEfiMdeModulePkgTokenSpaceGuid.PcdConOutColumn|90
  gEfiMdeModulePkgTokenSpaceGuid.PcdConOutRow|77
