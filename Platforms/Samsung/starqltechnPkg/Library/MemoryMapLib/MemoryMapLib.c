...
gMemoryRegionDescriptorEx[] = {
  ...
  {"RAM_Partition",      0x85700000, 0x00800000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  {"HLOS1",              0x85F00000, 0x000C0000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN},
  {"RAM_Partition",      0x85FC0000, 0x00020000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  {"AOP_CMD_DB",         0x85FE0000, 0x00020000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN},
  {"SMEM",               0x86000000, 0x00200000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"RAM_Partition",      0x86200000, 0x10000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  {"DXE_Heap",           0x96200000, 0x07130000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  {"DBI_Dump",           0x9D330000, 0x000D0000, NoHob,  MMAP_IO, INITIALIZED, Conv,   NS_DEVICE},
  ...
  {"IMEM_Base",          0x14680000, 0x0003F000, NoHob,  MMAP_IO, INITIALIZED, Conv,   NS_DEVICE},
