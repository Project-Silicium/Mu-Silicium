...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"UEFI FD",           0xF8000000, 0x00300000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
  {"DXE Heap",          0xF8300000, 0x07900000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
