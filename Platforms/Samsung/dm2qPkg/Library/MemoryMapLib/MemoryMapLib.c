...
gMemoryRegionDescriptorEx[] = {
  ...
  {"Reserved FD",       0xA7000000, 0x00600000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
  ...
  {"RAM Partition",     0x100000000, 0x780000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN},
