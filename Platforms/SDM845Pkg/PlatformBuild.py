# @file
# Script to Build SDM845 Mu UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SDM845Pkg",)
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('SDM845', 'mu-build', 'cibuild')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SDM845", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SDM845Pkg/SDM845.dsc", "Platform Hardcoded")
        ...
        self.env.SetValue("BLD_*_DISPLAY_PANEL", self.env.GetValue("DISPLAY_PANEL"), "Default")
