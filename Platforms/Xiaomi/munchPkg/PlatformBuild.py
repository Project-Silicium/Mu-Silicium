# @file
# Script to Build Xiaomi Poco F3 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("munchPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('munch', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "munch", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "munchPkg/munch.dsc", "Platform Hardcoded")
