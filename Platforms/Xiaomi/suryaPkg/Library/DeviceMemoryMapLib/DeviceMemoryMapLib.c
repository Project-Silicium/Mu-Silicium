...
gDeviceMemoryDescriptorEx[] = {
  ...
  {"AOP Image",         0x80600000, 0x00020000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"AOP CMD DB",        0x80620000, 0x00020000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"GPU PRR",           0x80640000, 0x00010000, AddMem, MEM_RES, WRITE_COMBINEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"RAM Partition",     0x80650000, 0x002AF000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN},
  ...
  {"QSEE",              0x80B00000, 0x02D00000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
  {"HLOS Entry1",       0x84400000, 0x01700000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   UNCACHED_UNBUFFERED_XN},
  {"HLOS Entry2",       0x85B00000, 0x01F90000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
  {"DBI Dump",          0x87A90000, 0x00D70000, NoHob,  MMAP_IO, INITIALIZED, Conv, UNCACHED_UNBUFFERED_XN},
  ...
  {"MPSS_EFS",          0x9FA00000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, UNCACHED_UNBUFFERED_XN},
  ...
  {"DXE Heap",          0xA0000000, 0x04500000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv,   WRITE_BACK_XN},
