...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("lmiPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('lmi', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "lmi", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "lmiPkg/lmi.dsc", "Platform Hardcoded")
