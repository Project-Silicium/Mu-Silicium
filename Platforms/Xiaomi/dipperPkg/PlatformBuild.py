...
class CommonPlatform ():
    PackagesSupported = ("dipperPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('dipper', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "dipper", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "dipperPkg/dipper.dsc", "Platform Hardcoded")
