# @file
# Script to Build SM8450 UEFI firmware
#
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "SM8450Pkg/SM8450.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "SM8450", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SM8450Pkg/SM8450.dsc", "Platform Hardcoded")
