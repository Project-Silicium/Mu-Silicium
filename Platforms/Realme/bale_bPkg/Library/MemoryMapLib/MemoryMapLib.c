...
gMemoryDescriptor[] = {
  ...
  {"RAM_Partition",       0xA7600000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
  ...
  {"UEFI_FD",             0xE6440000, 0x00300000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
