...
class CommonPlatform ():
    PackagesSupported = ("senna_aPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('senna_a', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "senna_a", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "senna_aPkg/senna_a.dsc", "Platform Hardcoded")
