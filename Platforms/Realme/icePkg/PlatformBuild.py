...
class CommonPlatform ():
    PackagesSupported = ("icePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ice', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "ice", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "icePkg/ice.dsc", "Platform Hardcoded")
