# @file
# Script to Build OnePlus 8T UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("hotdogPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('hotdog', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "hotdogPkg/hotdog.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "hotdog", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "hotdogPkg/hotdog.dsc", "Platform Hardcoded")
