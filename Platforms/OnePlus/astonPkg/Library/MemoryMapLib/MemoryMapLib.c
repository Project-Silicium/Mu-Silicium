...
gMemoryRegionDescriptorEx[] = {
  ...
  {"PIL_Reserved",      0x89800000, 0x19280000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  ...
  {"DXE_Heap",          0xBAE00000, 0x07C00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
//{"RAM_Partition",     0xC2A00000, 0x15600000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},

  // Memory Hole: 0xD8000000 -> 0xD8140000 (0x00140000)

  {"TZApps_Reserved",   0xD8800000, 0x08A00000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
