...
class CommonPlatform ():
    PackagesSupported = ("salamiPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('salami', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "salami", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "salamiPkg/salami.dsc", "Platform Hardcoded")
