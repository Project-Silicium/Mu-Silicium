...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a57, mProcessorInfoType4Strings, NULL);
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1IC_a57, mCacheInfoType7_L1ICStrings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1DC_a57, mCacheInfoType7_L1DCStrings, &SmbiosHandle);
  
  mProcessorInfoType4_a57.L1CacheHandle = (UINT16)SmbiosHandle;

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C_a57, mCacheInfoType7_L2CStrings, &SmbiosHandle);

  mProcessorInfoType4_a57.L2CacheHandle = (UINT16)SmbiosHandle;
