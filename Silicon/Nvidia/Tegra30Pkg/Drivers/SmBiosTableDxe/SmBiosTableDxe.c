...
#if SOC_TYPE == 0
  mProcessorInfoType4.MaxSpeed     = 1300;
  mProcessorInfoType4.CurrentSpeed = 1300;
#elif SOC_TYPE == 1 || SOC_TYPE == 2
  mProcessorInfoType4.MaxSpeed     = 1500;
  mProcessorInfoType4.CurrentSpeed = 1500;
#else
  mProcessorInfoType4.MaxSpeed     = 1700;
  mProcessorInfoType4.CurrentSpeed = 1700;
#endif
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  // Update Cache Size
  mCacheInfoType7_L1IC.MaximumCacheSize = 0x20;
  mCacheInfoType7_L1IC.InstalledSize    = 0x20;
  mCacheInfoType7_L1DC.MaximumCacheSize = 0x20;
  mCacheInfoType7_L1DC.InstalledSize    = 0x20;
  mCacheInfoType7_L2C.MaximumCacheSize  = 0x400;
  mCacheInfoType7_L2C.InstalledSize     = 0x400;
...
MemDevInfoUpdateSmbiosType17 (IN UINT64 SystemMemorySize)
{
  // Update DDR Freq
#if SOC_TYPE == 0
  mMemDevInfoType17.Speed                      = 1333 * 2;
  mMemDevInfoType17.ConfiguredMemoryClockSpeed = 1333;
#elif SOC_TYPE == 1 || SOC_TYPE == 2
#if RAM_MODEL == 0
  mMemDevInfoType17.Speed                      = 1500 * 2;
  mMemDevInfoType17.ConfiguredMemoryClockSpeed = 1500;
#else
  mMemDevInfoType17.Speed                      = 1066 * 2;
  mMemDevInfoType17.ConfiguredMemoryClockSpeed = 1066;
#endif
#else
