...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a9, mProcessorInfoType4Strings, NULL);
}
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  mProcessorInfoType4_a9.L1CacheHandle = (UINT16)SmbiosHandle;

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C, mCacheInfoType7_L2CStrings, &SmbiosHandle);

  mProcessorInfoType4_a9.L2CacheHandle = (UINT16)SmbiosHandle;
}
