...
InitSpeedy ()
{
  ...
  MmioWrite32 (0x15970000 + SPEEDY_INT_STATUS, 0xFFFFFFFF);
  MmioWrite32 (0x15980000 + SPEEDY_INT_STATUS, 0xFFFFFFFF);

  // Reset Speedy
  SWResetSpeedy (0x15970000);
  SWResetSpeedy (0x15980000);

  // Enable Speedy
  EnableSpeedy (0x15970000);
  EnableSpeedy (0x15980000);
}
