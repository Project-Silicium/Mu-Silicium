...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  mProcessorInfoType4.MaxSpeed     = 2900;
  mProcessorInfoType4.CurrentSpeed = 2900;
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  // Update Cache Size
  mCacheInfoType7_L1IC.MaximumCacheSize = 0x100;
  mCacheInfoType7_L1IC.InstalledSize    = 0x100;
  mCacheInfoType7_L1DC.MaximumCacheSize = 0x80;
  mCacheInfoType7_L1DC.InstalledSize    = 0x80;
  mCacheInfoType7_L2C.MaximumCacheSize  = 0x800;
  mCacheInfoType7_L2C.InstalledSize     = 0x800;
  mCacheInfoType7_L3C.MaximumCacheSize  = 0x1000;
  mCacheInfoType7_L3C.InstalledSize     = 0x1000;
...
{
  // Update DDR Freq
  mMemDevInfoType17.Speed                      = 1800 * 2;
  mMemDevInfoType17.ConfiguredMemoryClockSpeed = 1800;
