...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_m3,  mProcessorInfoType4Strings, NULL);
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1IC_m3,  mCacheInfoType7_L1ICStrings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1IC_a55, mCacheInfoType7_L1ICStrings, NULL);

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L1DC_m3, mCacheInfoType7_L1DCStrings, &SmbiosHandle);
  
  mProcessorInfoType4_m3.L1CacheHandle = (UINT16)SmbiosHandle;
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C_m3, mCacheInfoType7_L2CStrings, &SmbiosHandle);
  ...
  mProcessorInfoType4_m3.L3CacheHandle  = (UINT16)SmbiosHandle;
}
