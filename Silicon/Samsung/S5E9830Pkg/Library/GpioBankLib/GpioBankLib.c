...
gGpioBanks[] = {
  ...
  // GPB Banks
  {
    ...
    GPIO_BANK_ID_B,
    {
      ...
      {1, 0x0100, EFI_PINCTRL_PERIC1_ADDRESS},
      {2, 0x0120, EFI_PINCTRL_PERIC1_ADDRESS}
    }
  },
  ...
  // GPF Banks
  {
    ...
    GPIO_BANK_ID_F,
    {
      ...
      {1, 0x0020, EFI_PINCTRL_HSI1_ADDRESS},
      {2, 0x0040, EFI_PINCTRL_HSI1_ADDRESS},
      {3, 0x0000, EFI_PINCTRL_HSI2_ADDRESS}
    }
  },
  ...
  // GPG Banks
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x00A0, EFI_PINCTRL_PERIC0_ADDRESS},
      {1, 0x00C0, EFI_PINCTRL_PERIC1_ADDRESS}
    }
  },
  ...
  // GPM Banks
  {
    ...
    GPIO_BANK_ID_M,
    {
      ...
      {32, 0x0400, EFI_PINCTRL_CMGP_ADDRESS},
      {33, 0x0420, EFI_PINCTRL_CMGP_ADDRESS}
    }
  },
  ...
  // GPP Banks
  {
    ...
    GPIO_BANK_ID_P,
    {
      ...
      {4, 0x0080, EFI_PINCTRL_PERIC0_ADDRESS},
      {5, 0x0000, EFI_PINCTRL_PERIC1_ADDRESS},
      {6, 0x0020, EFI_PINCTRL_PERIC1_ADDRESS},
      {7, 0x0040, EFI_PINCTRL_PERIC1_ADDRESS},
      {8, 0x0060, EFI_PINCTRL_PERIC1_ADDRESS},
      {9, 0x0080, EFI_PINCTRL_PERIC1_ADDRESS},
    }
  },
  ...
  // GPV Banks
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x00A0, EFI_PINCTRL_VTS_ADDRESS}
    }
  }
};
