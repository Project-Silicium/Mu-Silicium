...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_x2,  mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a71, mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a51, mProcessorInfoType4Strings, NULL);
}
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  mProcessorInfoType4_x2.L1CacheHandle  = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a71.L1CacheHandle = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a51.L1CacheHandle = (UINT16)SmbiosHandle;

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C_x2, mCacheInfoType7_L2CStrings, &SmbiosHandle);

  mProcessorInfoType4_x2.L2CacheHandle = (UINT16)SmbiosHandle;

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C_a71, mCacheInfoType7_L2CStrings, &SmbiosHandle);

  mProcessorInfoType4_a71.L2CacheHandle = (UINT16)SmbiosHandle;

  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mCacheInfoType7_L2C_a51, mCacheInfoType7_L2CStrings, &SmbiosHandle);

  mProcessorInfoType4_a51.L2CacheHandle = (UINT16)SmbiosHandle;
}
