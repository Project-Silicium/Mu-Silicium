...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_x3,   mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a715, mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a710, mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a510, mProcessorInfoType4Strings, NULL);
}
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  mProcessorInfoType4_x3.L1CacheHandle   = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a715.L1CacheHandle = (UINT16)SmbiosHandle;
