...
ProcessorInfoUpdateSmbiosType4 ()
{
  ...
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_x1,  mProcessorInfoType4Strings, NULL);
  LogSmbiosData ((EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a78, mProcessorInfoType4Strings, NULL);
...
CacheInfoUpdateSmbiosType7 ()
{
  ...
  mProcessorInfoType4_x1.L3CacheHandle = (UINT16)SmbiosHandle;
}
