...
************************************************************************/
SMBIOS_TABLE_TYPE4 mProcessorInfoType4_a76_Prime = {
    ...
    0,                     // ExternalClock;
#if SOC_TYPE == 2 //Pointless for this SoC SM8150, anyways
    2956,                  // MaxSpeed;
    2956,                  // CurrentSpeed;
#elif SOC_TYPE == 1 //Pointless for this SoC SM8150, anyways
    2956,                  // MaxSpeed;
    2956,                  // CurrentSpeed;
#else  //Pointless for this SoC SM8150, anyways
    2956,                  // MaxSpeed;
    2956,                  // CurrentSpeed;
#endif
    0x41,                  // Status;
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L2 = {
    ...
    0x381, // Cache Configuration
           ...
           // Operational Mode   :2  (Unknown)
           // Reserved           :6
    0x0100, // Maximum Size        ??256 => 0x0100
    0x0100, // Install Size
    {
        // Supported SRAM Type
        0, // Other             :1
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_L3 = {
    ...
    0x382, // Cache Configuration
           ...
           // Operational Mode   :2  (Unknown)
           // Reserved           :6
    0x0400, // Maximum Size       ??1024 => 0x0400
    0x0400, // Install Size
    {
        // Supported SRAM Type
        0, // Other             :1
...
CHAR8 *mCacheInfoType7Strings[] = {"L1", "L2", "L3", NULL};
...
VOID ProcessorInfoUpdateSmbiosType4(VOID)
{
  ...
  LogSmbiosData(
      (EFI_SMBIOS_TABLE_HEADER *)&mProcessorInfoType4_a76_Prime,
...
VOID CacheInfoUpdateSmbiosType7(VOID)
{
  ...
  mProcessorInfoType4_a76_Prime.L1CacheHandle = (UINT16)SmbiosHandle;
  ...
  LogSmbiosData(
      ...
      mCacheInfoType7Strings, &SmbiosHandle);
  mProcessorInfoType4_a76_Prime.L2CacheHandle = (UINT16)SmbiosHandle;
  ...
  LogSmbiosData(
      ...
      mCacheInfoType7Strings, &SmbiosHandle);
  mProcessorInfoType4_a76_Prime.L3CacheHandle = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a76.L3CacheHandle = (UINT16)SmbiosHandle;
  mProcessorInfoType4_a55.L3CacheHandle = (UINT16)SmbiosHandle;
}
