...
#define MS_GRAPHICS_MED_PURPLE_COLOR          {.Blue = 0x4C, .Green = 0x06, .Red = 0x67, .Reserved = 0xFF}
#define MS_GRAPHICS_LIGHT_PURPLE_COLOR        {.Blue = 0x6F, .Green = 0x37, .Red = 0x85, .Reserved = 0xFF}

MS_COLOR_TABLE gMsColorTable = {
  //// Color definitions per view
  // Label
  .LabelTextNormalColor                    = MS_GRAPHICS_WHITE_COLOR,
  .LabelTextLargeColor                     = MS_GRAPHICS_MED_PURPLE_COLOR,
  ...
  .ListBoxSelectColor                      = MS_GRAPHICS_MED_PURPLE_COLOR,
  ...
  .ButtonTextNormalColor                   = MS_GRAPHICS_MED_PURPLE_COLOR,
  ...
  // ToggleSwitch
  .ToggleSwitchOnColor                     = MS_GRAPHICS_MED_PURPLE_COLOR,
  ...
  .ToggleSwitchTextFGColor                 = MS_GRAPHICS_WHITE_COLOR,
  .ToggleSwitchTextBGColor                 = MS_GRAPHICS_BLACK_COLOR,
  .ToggleSwitchHighlightBGColor            = MS_GRAPHICS_WHITE_COLOR,
  .ToggleSwitchBackgroundColor             = MS_GRAPHICS_BLACK_COLOR,
  .ToggleSwitchCircleGrayoutColor          = MS_GRAPHICS_MED_GRAY_1_COLOR,

  // Message Box
  .MessageBoxTextColor                     = MS_GRAPHICS_WHITE_COLOR,
  .MessageBoxTitleBarTextColor             = MS_GRAPHICS_WHITE_COLOR,
  .MessageBoxBackgroundColor               = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .MessageBoxBackgroundAlert1Color         = MS_GRAPHICS_RED_COLOR,
  .MessageBoxBackgroundAlert2Color         = MS_GRAPHICS_MED_PURPLE_COLOR,
  .MessageBoxDialogFrameColor              = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .MessageBoxButtonHoverColor              = MS_GRAPHICS_MED_PURPLE_COLOR,
  .MessageBoxButtonSelectColor             = MS_GRAPHICS_LIGHT_PURPLE_COLOR,
  ...
  .PasswordDialogTitleBarTextColor         = MS_GRAPHICS_WHITE_COLOR,
  ...
  .PasswordDialogEditBoxGrayoutTextColor   = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .PasswordDialogTextSelectColor           = MS_GRAPHICS_RED_COLOR,
  .PasswordDialogBackGroundColor           = MS_GRAPHICS_RED_COLOR,
  .PasswordDialogFrameColor                = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  ...
  .DefaultTitleBarTextColor                = MS_GRAPHICS_WHITE_COLOR,
  .DefaultErrorTextColor                   = MS_GRAPHICS_YELLOW_COLOR,
  .DefaultEditBoxBackGroundColor           = MS_GRAPHICS_WHITE_COLOR,
  .DefaultEditBoxTextColor                 = MS_GRAPHICS_BLACK_COLOR,
  .DefaultEditBoxGrayOutColor              = MS_GRAPHICS_LIGHT_GRAY_3_COLOR,
  .DefaultEditBoxGrayOutTextColor          = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .DefaultDialogTextSelectColor            = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .DefaultDialogBackGroundColor            = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .DefaultDialogFrameColor                 = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .DefaultDialogButtonHoverColor           = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .DefaultDialogButtonSelectColor          = MS_GRAPHICS_LIGHT_PURPLE_COLOR,
  ...
  .SingleSelectDialogTitleBarTextColor     = MS_GRAPHICS_WHITE_COLOR,
  .SingleSelectDialogDialogBackGroundColor = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .SingleSelectDialogDialogFrameColor      = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .SingleSelectDialogButtonHoverColor      = MS_GRAPHICS_DARK_GRAY_1_COLOR,
  .SingleSelectDialogButtonSelectColor     = MS_GRAPHICS_LIGHT_PURPLE_COLOR,
  ...
  .SingleSelectDialogListBoxGreyoutColor   = MS_GRAPHICS_LIGHT_GRAY_3_COLOR,
  ...
  .KeyboardShiftStateFGColor               = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardShiftStateBGColor               = MS_GRAPHICS_WHITE_COLOR,
  .KeyboardCapsLockStateKeyColor           = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardCapsLockStateFGColor            = MS_GRAPHICS_WHITE_COLOR,
  .KeyboardCapsLockStateBGColor            = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardNumSymStateKeyColor             = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardNumSymStateFGColor              = MS_GRAPHICS_GRAY_KEY_FILL_COLOR,
  .KeyboardNumSymA0StateFGColor            = MS_GRAPHICS_WHITE_COLOR,
  .KeyboardNumSymA0StateBGColor            = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardFunctionStateKeyColor           = MS_GRAPHICS_MED_PURPLE_COLOR,
  .KeyboardFunctionStateFGColor            = MS_GRAPHICS_WHITE_COLOR,
  .KeyboardFunctionStateBGColor            = MS_GRAPHICS_MED_PURPLE_COLOR,
  ...
  // Display Engine
  .TitleBarBackgroundColor                 = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .TitleBarTextColor                       = MS_GRAPHICS_WHITE_COLOR,
  .MasterFrameBackgroundColor              = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .MasterFrameCellNormalColor              = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .MasterFrameCellHoverColor               = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .MasterFrameCellSelectColor              = MS_GRAPHICS_MED_PURPLE_COLOR,
  .MasterFrameCellGrayoutColor             = MS_GRAPHICS_DARK_GRAY_2_COLOR,
  .FormCanvasBackgroundColor               = MS_GRAPHICS_BLACK_COLOR
};
